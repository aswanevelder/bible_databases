...
> Every term in this glossary has a committed Afrikaans rendering. Claude must
> follow these renderings unless explicitly overruled in a chapter's notes
> (with reason). New terms are added during translation work and reviewed by
> the team before being committed here.
>
> **Format**: `Source (transliteration) → Afrikaans rendering | notes`
>
> **Status legend**:
> - ✅ Committed — use this rendering, no exceptions
> - 🟡 Provisional — used pending team review
> - 🔴 Open — multiple candidates, decision needed before next chapter

---

## Divine names and titles

| Hebrew/Greek | Translit. | Afrikaans | Status | Notes |
|---|---|---|---|---|
| יהוה | YHWH | **HERE** (all caps) | ✅ | The Tetragrammaton; matches AFR53 convention |
| אֲדֹנָי | Adonai | **Here** | ✅ | "Lord" as divine title |
| אֲדֹנָי יהוה | Adonai YHWH | **Here HERE** | ✅ | Compound divine name |
| יהוה אֱלֹהִים | YHWH Elohim | **HERE God** | ✅ | Compound used throughout Gen 2–3; standing rendering (committed 2026-05-30, Gen 2) |
| אֱלֹהִים | Elohim | **God** | ✅ | Generic; plural form, singular meaning |
| אֵל | El | **God** | ✅ | Singular generic |
| אֵל שַׁדַּי | El Shaddai | **God die Almagtige** | 🟡 | Or transliterate "El Sjaddai"? |
| אֵל עֶלְיוֹן | El Elyon | **God die Allerhoogste** | 🟡 | |
| יהוה צְבָאוֹת | YHWH Tsevaot | **HERE van die leërskare** | 🟡 | AFR53: "HERE van die leërskare" |
| θεός | theos | **God** | ✅ | |
| κύριος | kurios | **Here** | ✅ | Referring to God or Jesus |
| πατήρ | patēr | **Vader** | ✅ | (cap when referring to God) |
| υἱός | huios | **Seun** | ✅ | (cap when referring to Christ) |
| Χριστός | Christos | **Christus** | ✅ | |
| Μεσσίας | Messias | **Messias** | ✅ | |
| λόγος | logos | **Woord** | ✅ | (cap when referring to Christ, John 1) |
...
| Hebrew/Greek | Translit. | Afrikaans | Status | Notes |
|---|---|---|---|---|
| חֶסֶד | chesed | **troue liefde** | ✅ | Committed 2026-05-30. Covenant-loyalty sense; "goedertierenheid" (AFR53) rejected as archaic. |
| אַהֲבָה | ahavah | **liefde** | ✅ | |
| ἀγάπη | agapē | **liefde** | ✅ | |
| חֵן | chen | **genade** | ✅ | |
| χάρις | charis | **genade** | ✅ | |
| אֱמוּנָה | emunah | **geloof** / **trou** | 🟡 | Context-dependent. Document choice per occurrence until pattern clear. |
| πίστις | pistis | **geloof** | ✅ | |
| צֶדֶק / צְדָקָה | tsedeq / tsedaqah | **geregtigheid** | ✅ | |
| δικαιοσύνη | dikaiosunē | **geregtigheid** | ✅ | |
| חַטָּאת | chatta't | **sonde** | ✅ | |
| ἁμαρτία | hamartia | **sonde** | ✅ | |
| פֶּשַׁע | pesha | **oortreding** | ✅ | Distinct from "sonde" |
| עָוֹן | avon | **ongeregtigheid** | ✅ | |
...
| δόξα | doxa | **heerlikheid** | ✅ | |
| קָדוֹשׁ | qadosh | **heilig** | ✅ | |
| ἅγιος | hagios | **heilig** | ✅ | |
| נֶפֶשׁ | nephesh | **lewende wese** / **lewe** / **siel** | ✅ | Committed 2026-05-30. Context rules: `lewende wese` for creatures (incl. Gen 2:7), `lewe` where it means life, `siel` only for clearly inner/emotional contexts. Document choice per occurrence. |
| ψυχή | psuchē | **siel** / **lewe** | ✅ | Committed 2026-05-30; match nephesh by context. |
| נְשָׁמָה | neshamah | **asem** | ✅ | "asem van die lewe" (Gen 2:7); keep distinct from *ruach* (Gees/wind) and *nephesh* (wese). Committed 2026-05-30 |
| בָּשָׂר | basar | **vlees** | ✅ | |
| σάρξ | sarx | **vlees** | ✅ | |
| לֵב / לֵבָב | lev / levav | **hart** | ✅ | |
| καρδία | kardia | **hart** | ✅ | |
| אֱמֶת | emet | **waarheid** | ✅ | |
...
## Cultic and ritual vocabulary

| Hebrew/Greek | Translit. | Afrikaans | Status | Notes |
|---|---|---|---|---|
| כֹּהֵן | kohen | **priester** | ✅ | |
| ἱερεύς | hiereus | **priester** | ✅ | |
| נָבִיא | nabi | **profeet** | ✅ | |
| προφήτης | prophētēs | **profeet** | ✅ | |
| מֶלֶךְ | melek | **koning** | ✅ | |
| βασιλεύς | basileus | **koning** | ✅ | |
| הֵיכָל | heikal | **tempel** | ✅ | |
| ναός | naos | **tempel** | ✅ | The inner sanctuary. Where contrasted with *hieron* (e.g. John 2:19–21, body-as-temple), keep "tempel" and footnote the distinction. |
| ἱερόν | hieron | **tempel** | ✅ | Committed 2026-05-30 (John 2): single rendering "tempel" + footnote where the *naos*/*hieron* contrast carries meaning; not forced into "tempelgebou/heiligdom". |
| πάσχα | Pascha | **Pasga** | ✅ | Committed 2026-05-30 (John 2). Jewish Passover; deliberately NOT "Paasfees" (= Easter). Gospel-wide convention. |
| ἑορτή | heortē | **fees** | ✅ | Committed 2026-05-30 (John 2:23); the festival. |
| מִשְׁכָּן | mishkan | **tabernakel** | ✅ | |
| מִזְבֵּחַ | mizbeach | **altaar** | ✅ | |
...
| κρίσις | krisis | **oordeel** | ✅ | |

---

## Creation and cosmology vocabulary

| Hebrew/Greek | Translit. | Afrikaans | Status | Notes |
|---|---|---|---|---|
| בָּרָא | bara | **skep** | ✅ | Used only of God; preserve distinction from *asah* |
...
|---|---|---|---|---|
| μονογενής | monogenēs | **enigste** / **Enigste** | ✅ | Committed 2026-05-30. "Unique/one-of-a-kind" over "eniggebore". Cap for Christ. Affects John 1:14, 1:18, 3:16, 1 John 4:9, Heb 11:17. |
...
| ἀπόστολος | apostolos | **apostel** | ✅ | |
| μαθητής | mathētēs | **dissipel** | ✅ | |
| διάβολος | diabolos | **duiwel** | ✅ | |
| σατανᾶς | satanas | **Satan** | ✅ | (cap as proper noun) |
| ἄγγελος | angelos | **engel** | ✅ | "Boodskapper" only when human messengers in context |
| σημεῖον | sēmeion | **teken** | ✅ | Committed 2026-05-30 (John 2). John's term for Jesus' significant acts; NOT "wonder/mirakel". Recurs throughout John. |
| ἀρχιτρίκλινος | architriklinos | **seremoniemeester** | ✅ | Committed 2026-05-30 (John 2:8–9). Master of the banquet; chosen over "tafelmeester"/"hoofkelner". |
| ἐμπόριον | emporion | **handelshuis** | ✅ | Committed 2026-05-30 (John 2:16). |
| γυνή (voc. γύναι) | gunai | **Vrou** (aanspreekvorm) | ✅ | Committed 2026-05-30 (John 2:4). Retain the literal courteous vocative; footnote the strikingness rather than soften to "Moeder". |

---

## Numbers and measurements

> To be populated as encountered. Decision needed early: do we modernize
> measurements (e.g. cubits → meters) or preserve the source units with
> footnotes? Recommend **preserve and footnote** for faithfulness.

| Hebrew/Greek | Translit. | Afrikaans | Status |
|---|---|---|---|
| אַמָּה | amah | **el** | 🟡 |
| שֶׁקֶל | shekel | **sikkel** | 🟡 |
| μετρητής | metrētēs | **metrete** (footnote ≈ 39 liter) | ✅ |
...
## Pending decisions — RESOLVE BEFORE NEXT BATCH

All five previously-listed 🔴 decisions were **resolved and committed on 2026-05-30**
(see `TRANSLATION_POLICY.md` § 2 and `REVIEW_LOG.md`):

1. ~~**nephesh** rendering policy~~ → ✅ context rules (`lewende wese` / `lewe` / `siel`)
2. ~~**monogenēs** policy~~ → ✅ **enigste**
3. ~~**amēn amēn** policy~~ → ✅ **Voorwaar, voorwaar**
4. ~~**chesed**~~ → ✅ **troue liefde**
5. ~~**yeshu'ah / sōtēria**~~ → ✅ **verlossing**

**No 🔴 glossary blockers remain.** Still-open *policy* items (not word-level) are tracked
in `TRANSLATION_POLICY.md` § 6 — most notably the OT-quoted-in-NT rendering policy, needed
before large-scale work in Matthew/Romans/Hebrews. Chapters touching any future 🔴 entry
must be marked "draft pending policy" and held in `flagged/`.

---

## Maintenance

- This file is the source of truth for terminology
- Every new chapter should propose additions in its "Glossary additions" section
- The team commits additions in a weekly (or per-batch) review
- Status changes (🔴 → 🟡 → ✅) are recorded in `REVIEW_LOG.md`
- If a committed term is revised, every completed chapter using it must be flagged for re-review
