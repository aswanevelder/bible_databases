...
| 2026-05-31 | Genesis 7 | self-review | Claude (assistant) | Initial draft in `drafts/genesis/genesis-07.md`. The flood begins — Noag enters the ark, clean/unclean animals, the waters prevail. First *tahor*/*tame*→"rein"/"onrein"; *gavar*→"die oorhand kry"; the cosmic un-creation (tehom + sluise undoing 1:6–7) and "die HERE het agter hom toegesluit" (7:16) footnoted; numerals/dates. **Awaiting human review.** Open: small-number convention (sewe/twee), "sewe pare" vs "sewe-sewe". |
