...
|---|---|---|---|---|
| 2026-06-07 | Genesis 10 | **promoted** | Anton Swanevelder (project owner) | The Table of Nations (Völkertafel) — the *toledot* of Noag's sons; Japheth, Ham (incl. Nimrod), Shem. Promoted to `completed/genesis/genesis-10.md`. Review decisions: ***gibbor* → "geweldige"** via a committed **sense-split** (singular "geweldige" / plural *gibborim* "helde", Gen 6:4); ***Ashur* at v.11 → Nimrod going "na Assirië"** (the land, as 2:14; the MT-subject "Assur builds Nineveh" reading footnoted); **proper-name distinctions** confirmed — Seba (סְבָא) vs Skeba (שְׁבָא), Assur (person, v.22) vs Assirië (land, v.11), Misraim (eponym) vs Egipte (country); ***-im*/*-i* gentilics → peoples** (*-iete*/*-iërs*); **Dodanim** (MT) in body, Rodanim footnoted; **v.21 → Jafet as die oudste** (Shem-as-elder reading footnoted). Peleg/*palag* pun (v.25) footnoted; the Gen 10:25 ↔ 1 Chr 1:19 parallel already in `CROSS_REFERENCE.md`. Committed 6 glossary terms + ~55 proper names. Single-reviewer promotion (compliant with CLAUDE.md Step 6). |
...
| 2026-06-02 | Genesis 9 | **promoted** | Anton Swanevelder (project owner) | The Noahic covenant + rainbow, renewed blessing, blood/life law, Noag & sons (curse of Kanaän). Promoted to `completed/genesis/genesis-09.md`. Review decisions: ***qeshet* → "boog"** (literal + footnote, team decision over "reënboog" — keeps the war-bow imagery of God laying down His weapon); ***eved* → "slaaf"** at 9:25–27, committed as a **context rule** (cf. *nephesh*): "slaaf" for forced bondage (*eved avadim* → "slaaf van slawe"), "kneg" reserved for servant/official and the LORD's servant when those occur — **not flat**; **Kanaän** registered in `PROPER_NAMES.md` (the curse falls on Kanaän, not Gam — footnoted). v.6 image-of-God chiasm footnoted; Japheth name-pun (9:27); v.29 death-formula matches Genesis 5. Committed: qeshet, baruch, yayin, karem, ervah, eved, shakhar. Carried over: berit, ot, tselem, arar→vervloek, zakhar→onthou (as 8:1). |
| 2026-06-02 | Genesis 8 | **promoted** | Anton Swanevelder (project owner) | The waters recede — God remembers Noag, the ark rests on Ararat, raaf & duif, the altar & promise. Promoted to `completed/genesis/genesis-08.md`. Review decisions: ***olah* → "brandoffer"** (committed; distinct from *zevach*/*minchah*); ***qalal* at 8:21 → "vervloek"** (team decision — keep the strong echo of the 3:17 ground-curse, **deliberately sharing "vervloek" with *arar***, the distinct-verb point carried by the footnote not the body); ***qalal*-abate (vv.8, 11) → "weggetrek"** (glossary corrected from a mislabelled "bedaar/afneem"; kept distinct from *shakhakh*→bedaar v.1 and *chaser*→afgeneem vv.3, 5); **Ararat** registered in `PROPER_NAMES.md`. Carried over: *tahor*→"rein" (Gen 7), *yetzer*→"geneigdheid" (8:21 echoes 6:5), *ruach*→"wind" (8:1, echoes 1:2). Committed: olah, reach nichoach, qalal, challon, orev, yonah, mikhseh. |
| 2026-06-01 | Genesis 7 | **promoted** | Anton Swanevelder (project owner) | The flood begins — Noag enters the ark, clean/unclean animals, the waters prevail. Promoted to `completed/genesis/genesis-07.md`. Review decisions: **small-number convention confirmed** (numerals for dates/quantities, spelled small counts); ***shivah shivah* → "sewe-sewe"** (literal, matching "twee-twee" vv.9/15 — the "seven pairs" reading moved to the footnote, was "sewe pare"); ***tahor*/*tame* → "rein"/"onrein"** committed (first occurrence, pre-Mosaic). 7:1 reworded to natural subject-first order ("Ek het jou as regverdig…"); 7:3 "aan die lewe hou"; 7:16 kept "agter hom toegesluit" (Hebrew ellipsis, image carried by footnote). *gavar*→"die oorhand kry" refrain (vv.18–24); cosmic un-creation (tehom + sluise undoing 1:6–7) footnoted. Committed: tahor, tame, gavar, yequm, geshem, arubbot. No new proper names. |
...
| 2026-06-02 | Context-rules locked (🟡→✅) | Confirmed three context-rules already exercised consistently in shipped chapters, **no verse change** (status-only): ***tehom*** (diepwater for the Gen 1:2 water-mass / dieptes elsewhere, Gen 7:11), ***erets* / *gē*** (aarde=planet / land=territory; both arms proven Gen 1–4), ***archē*** ("begin" confirmed John 1:1-2, 2:11; "owerheid" arm still to debut). No DB rebuild needed (renderings unchanged). Still 🟡 and **not** locked: *eskēnōsen*, *katalambanō* (single-occurrence interpretive choices, not context-rules), and *aiōn*/*emunah*/*mishpat* (not yet in any shipped chapter). | Gen 1, 7; John 1, 2 (confirmations). |
| 2026-06-02 | *yetzer* rendering changed | Changed committed rendering **"versinsel" → "geneigdheid"** in `GLOSSARY.md` (versinsel leaned to the "device/imagination" sense; geneigdheid is the inclination/bent sense). **Re-passed the promoted Genesis 6** (6:5 retranslated + chapter glossary table updated) and the Genesis 8 draft (8:21 + notes); rebuilt the database. The deliberate 6:5 ↔ 8:21 echo is preserved (same word in both). | Genesis 6 (re-passed), Genesis 8 (draft); all later *yetzer* occurrences. |
...
| 2026-06-07 | Genesis 10 glossary additions | Committed to `GLOSSARY.md`: **gibbor**→geweldige (singular; sense-split with *gibborim*→helde), **goy**→nasie, **lashon**→taal, **mishpachah**→familie, **gevul**→grens, **iyyim**→kuslande. Registered ~55 Table-of-Nations proper names in `PROPER_NAMES.md` (Japheth/Ham/Shem lines + places), with the Seba/Skeba, Assur/Assirië and Misraim/Egipte distinctions documented. | Applied during Genesis 10 promotion; nations-formula terms recur in every genealogy/Völkertafel. |
